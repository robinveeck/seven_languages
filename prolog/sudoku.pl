...
sudoku(Puzzle, Solution) :-
	...
	valid([Row1, Row2, Row3, Row4, Row5, Row6, Row7, Row8, Row9,
	 Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8, Col8, Col9,
	 Square1, Square2, Square3, Square4, Square5, Square6, Square7, Square8, Square9]).


print_list(N, List) :- print_list(N, N, List).
print_list(N, Index, [Head|Tail]) :- (Index >= 1 -> tab(1), write(Head), Index1 is Index-1, print_list(N, Index1, Tail)
	; nl, print_list(N, N, [Head|Tail])).
print_list(_, _, []).

print_solutions([Head|Tail]) :- print_list(9, Head), print_solutions(Tail).

pretty_sudoku(Puzzle) :- 
	findall(Solution, sudoku(Puzzle, Solution), Solutions),
	print('Solution:'), nl,
